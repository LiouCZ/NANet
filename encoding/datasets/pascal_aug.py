...
class VOCAugSegmentation(BaseDataset):
    ...
    NUM_CLASS = 21
    TRAIN_BASE_DIR = 'VOCdevkit/VOC2012/'
    # TRAIN_BASE_DIR = 'VOCaug/dataset/'/ifs/home/caiyideng_data/lcz/deeplabv3plus-pytorch-master/data/VOCdevkit/VOC2012
    def __init__(self, root=os.path.expanduser('/ifs/home/caiyideng_data/lcz/deeplabv3plus-pytorch-master/data'), split='train',
    ...
    def __getitem__(self, index):
        ...
        if self.mode == 'train':
            ...
            target = self._mask_transform(_target)
