...
_TARGET_DIR = os.path.expanduser('/ifs/home/caiyideng_data/lcz/FastFCN-master/data')
...
if __name__ == '__main__':
    args = parse_args()
    mkdir(os.path.expanduser('/ifs/home/caiyideng_data/lcz/FastFCN-master/data'))
